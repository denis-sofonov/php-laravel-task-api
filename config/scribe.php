...
return [
    ...
    'description' => 'Token-authenticated REST API for managing projects and tasks.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Obtain a token from <code>POST /api/v1/login</code> or <code>POST /api/v1/register</code>, then send it as <code>Authorization: Bearer {token}</code>.',
    ],
